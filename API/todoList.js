...
const UPADTE_TODOLIST = `
mutation UpdateTodoLists($update: TodoListUpdateInput, $where: TodoListWhere) {
...
export function updateTodoList(id, newTitle, token) {
  return fetch(API_URL, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
